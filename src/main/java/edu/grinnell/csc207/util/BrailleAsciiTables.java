...
public class BrailleAsciiTables {
  ...
  /**
   * The length of the ASCII characters.
   */
  static final Integer ASCII_LENGTH = 8;

  /**
   * The length of the braille and Unicode characters.
   */
  static final Integer BRAILLE_AND_UNICODE_LENGTH = 6;
   ...
   * character.
   *
   * @param letter the ASCII character to be converted
   *
   * @return a string of bits representing the corresponding braille character
   */
  public static String toBraille(char letter) throws RuntimeException {
    if (a2bTree == null) {
      a2bTree = new BitTree(ASCII_LENGTH);
   ...
   * character.
   *
   * @param bits the string of bits representing the braille character to be converted
   *
   * @return the corresponding ASCII character
   *
   * @throws RuntimeException if the string of bits does not correspond to any ASCII character or
   *         there was an error with loading the file
   */
  public static String toAscii(String bits) throws RuntimeException {
    // Make sure we've loaded the braille-to-ASCII tree.
    if (b2aTree == null) {
      b2aTree = new BitTree(BRAILLE_AND_UNICODE_LENGTH);
  ...
  public static String toUnicode(String bits) {
    if (b2uTree == null) {
      b2uTree = new BitTree(BRAILLE_AND_UNICODE_LENGTH);
